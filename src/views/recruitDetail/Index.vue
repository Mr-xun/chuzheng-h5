    ...
    <div class="detail-container theme-color f14">
        <div class="company-info bg-white mb10">
            <h5 class="comp-name theme-color f16">
                北京城建集团有限公司
                <em class="status-sign"></em>
            </h5>
            <ul class="label-box flex-cross-center">
                <li class="label-item label-blue-bg flex-all-center">
                    <van-icon class="label-icon" name="eye-o" />
                    <span>天眼查</span>
                </li>
        ...
        <div class="drawing-box bg-white mb10">
            <h6 class="drawing-title">图纸</h6>
            <div class="drawing-imgs">
                <img src="../../assets/images/recruit-detail.png" alt />
            </div>
        </div>
        <div class="drawingAndVideo-box bg-white mb10">
            <h6 class="drawing-title">图纸及视频</h6>
            <div class="drawing-imgs">
                <img src="../../assets/images/recruit-detail.png" alt />
            </div>
        </div>
